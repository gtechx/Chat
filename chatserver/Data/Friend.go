...
func (rdm *RedisDataManager) AddFriendRequest(entity centity.UserEntity, otheruid uint64, group string) error {
...
func (rdm *RedisDataManager) RemoveFriendRequest(entity centity.UserEntity, otheruid uint64) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) AddFriend(entity centity.UserEntity, otheruid uint64, group string) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) RemoveFriend(entity centity.UserEntity, otheruid uint64, group string) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) GetFriendList(entity centity.UserEntity, group string) ([]uint64, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) IsFriend(entity centity.UserEntity, otheruid uint64) (bool, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) GetGroupOfFriend(entity centity.UserEntity, otheruid uint64) (string, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) AddGroup(entity centity.UserEntity, group string) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) RemoveGroup(entity centity.UserEntity, group string) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) GetGroupList(entity centity.UserEntity) ([]string, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) IsGroupExists(entity centity.UserEntity, group string) (bool, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) IsFriendInGroup(entity centity.UserEntity, otheruid uint64, group string) (bool, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) MoveFriendToGroup(entity centity.UserEntity, otheruid uint64, srcgroup, destgroup string) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
