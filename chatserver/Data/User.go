...
func (rdm *RedisDataManager) CreateAppData(entity centity.UserEntity) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) DeleteAppData(entity centity.UserEntity) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) IsAppDataExists(entity centity.UserEntity) (bool, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) SetAppDataConfig(entity centity.UserEntity, configname string, data interface{}) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) GetAppDataConfig(entity centity.UserEntity, configname string) (interface{}, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) SetUserOnline(entity centity.UserEntity) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
	conn.Send("MULTI")
...
func (rdm *RedisDataManager) SetUserOffline(entity centity.UserEntity) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
	conn.Send("MULTI")
...
func (rdm *RedisDataManager) SetUserState(entity centity.UserEntity, state uint8) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) AddUserToBlack(entity centity.UserEntity, otheruid uint64) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) RemoveUserFromBlack(entity centity.UserEntity, otheruid uint64) error {
	conn := rdm.redisPool.Get()
	defer conn.Close()
...
func (rdm *RedisDataManager) IsUserInBlack(entity centity.UserEntity, otheruid uint64) (bool, error) {
	conn := rdm.redisPool.Get()
	defer conn.Close()
